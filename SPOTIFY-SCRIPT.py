...
s3_path = "s3://spotify-etl-complete-project/raw_data/to_processed/"
...
def write_to_s3(df, path_suffix, format_type="csv"):
    ...
    glueContext.write_dynamic_frame.from_options(
        frame = dynamic_frame,
        connection_type = "s3",
        connection_options = {"path": f"s3://spotify-etl-complete-project/transformed_data/{path_suffix}/"},
        format = format_type
    )
...
bucket_name = 'spotify-etl-complete-project'
...
def move_and_delete_files(spotify_keys,Bucket):
    ...
    for key in spotify_keys:
        ...
        destination_key = 'raw_data/to_processed/' + key.split("/")[-1]
